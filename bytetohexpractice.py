...
def genran():
    return nums[random.randint(0,254)]
...
def guess():
    ...
    try:
        curguess = str(curguess)
    except ValueError:
        print("Invalid input!")
        return

    if (hexnum[2:].upper()) == curguess:
        correct += 1
        os.system("clear")
    else:
        incorrect += 1
        os.system("clear")
        print(f"Incorrect! Correct answer: {hexnum[2:].upper()}")
        time.sleep(2)
        os.system("clear")
